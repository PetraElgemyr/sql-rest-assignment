...
const seedStoresDb = async () => {
  try {
    ...
    const newUserPassword1 = createHashedPassword(passwordUser1);
    const newUserPassword2 = createHashedPassword(passwordUser2);
    const newUserPassword3 = createHashedPassword(passwordUser3);
    ...
    ('Lidl Göteborg', 'Kungsgatan 16', (SELECT id FROM citys c WHERE city_name = 'Göteborg'), (SELECT id FROM users WHERE email = 'ksenia.ivanova@gmail.com'), 'Vi pressar ner priserna utan att kvalitén ska ta stryk. För oss är det viktigt att bidra till hållbar och ansvarsfull odling av råvaror. Därför satsar vi bland annat på vårt ekologiska sortiment som fortsätter att växa. Vi har idag närmare 200 egna ekologiska varor och det kommer bara bli fler. Välkommen in till oss!',
    ...
    ('Coop: Jag har handlat på Coop i flera år och jag är alltid nöjd med deras utbud och kvalitet på matvaror.', 5, (SELECT id FROM stores WHERE store_name = 'Coop Hötorget'),(SELECT id FROM users WHERE email = 'user1@gmail.com')),
    ('ICA Nära är en liten och personlig matbutik som erbjuder bra kvalitet på matvaror. Jag gillar att de också har ett utbud av svenska produkter.', 4, (SELECT id FROM stores WHERE store_name = 'Ica Supermarket Alvikstorg'),(SELECT id FROM users WHERE email = 'user2@gmail.com')),
    ('För liten butik med dåligt utbud. Ok priser.', 2, (SELECT id FROM stores WHERE store_name = 'Ica Supermarket Alvikstorg'),(SELECT id FROM users WHERE email = 'user3@gmail.com')),
    ('Billigt men en aningen liten butik', 3, (SELECT id FROM stores WHERE store_name = 'Lidl Göteborg'),(SELECT id FROM users WHERE email = 'user2@gmail.com')),
    ('Bästa butiken att komplementhandla på! Så billig och fräsch frukt och grönt-avdelning', 5, (SELECT id FROM stores WHERE store_name = 'Lidl Göteborg'),(SELECT id FROM users WHERE email = 'user1@gmail.com')),
    ('Bra med veckans tema! Superkul idé och varierande varor', 5, (SELECT id FROM stores WHERE store_name = 'Lidl Medborgarplatsen'),(SELECT id FROM users WHERE email = 'user3@gmail.com')),
    ('Utplockat på söndagar', 1, (SELECT id FROM stores WHERE store_name = 'Lidl Medborgarplatsen'),(SELECT id FROM users WHERE email = 'user2@gmail.com')),
    ('Nära till kollektivtrafiken så lätt att hitta dit. Okej priser!', 3, (SELECT id FROM stores WHERE store_name = 'ICA Supermarket Majorna'),(SELECT id FROM users WHERE email = 'user2@gmail.com')),
    ('Bra alternativ på onlineshoppen men lite dyrt!', 4, (SELECT id FROM stores WHERE store_name = 'ICA Supermarket Majorna'),(SELECT id FROM users WHERE email = 'user1@gmail.com')),
    ('Bra deli och charkdisk', 4, (SELECT id FROM stores WHERE store_name = 'Stora Coop Stadion'),(SELECT id FROM users WHERE email = 'user3@gmail.com')),
    ('Dyrt för en pensionär!', 2, (SELECT id FROM stores WHERE store_name = 'Stora Coop Stadion'),(SELECT id FROM users WHERE email = 'user2@gmail.com')),
    ('Okej, inget mer än så', 3, (SELECT id FROM stores WHERE store_name = 'Ica Supermarket Hansa'),(SELECT id FROM users WHERE email = 'user3@gmail.com')),
    ('ÄLSKAR Hansa som ligger precis bredvid mig och billig!', 5, (SELECT id FROM stores WHERE store_name = 'Ica Supermarket Hansa'),(SELECT id FROM users WHERE email = 'user1@gmail.com')),
    ('Höga priser som allt annat i köpcentrumet...', 2, (SELECT id FROM stores WHERE store_name = 'Hemköp Triangeln'),(SELECT id FROM users WHERE email = 'user2@gmail.com')),
    ('Stor med jättebra utbud. Hittar alltid det jag behöver här!!', 5, (SELECT id FROM stores WHERE store_name = 'Hemköp Triangeln'),(SELECT id FROM users WHERE email = 'user3@gmail.com')),
    ('Sååå trevlig personal, alltid schyssta', 5, (SELECT id FROM stores WHERE store_name = 'ICA Supermarket Olskroken' ),(SELECT id FROM users WHERE email = 'user3@gmail.com')),
    ('Få kassor så det är alltid kö här tyvärr', 3, (SELECT id FROM stores WHERE store_name = 'ICA Supermarket Olskroken'),(SELECT id FROM users WHERE email = 'user1@gmail.com')),
    ('Jag gillar deras veckans erbjudande!', 4, (SELECT id FROM stores WHERE store_name = 'Coop Mölndalsvägen'),(SELECT id FROM users WHERE email = 'user2@gmail.com')),
    ('Jag uppskattar deras sortiment av färskvaror och deras lokala produkter', 4, (SELECT id FROM stores WHERE store_name = 'Coop Mölndalsvägen'),(SELECT id FROM users WHERE email = 'user3@gmail.com')),
